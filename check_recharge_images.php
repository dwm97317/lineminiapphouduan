...
try {
    ...
    if ($certificates) {
        ...
        foreach ($certificates as $cert) {
            ...
            if ($images) {
                ...
                foreach ($images as $img) {
                    if ($img['file_name']) {
                        $filePath = __DIR__ . '/web/' . $img['file_name'];
    ...
    if ($files) {
        ...
        foreach ($files as $file) {
            ...
            echo "<td style='font-size: 11px;'>{$file['file_name']}</td>";
    ...
    $rechargeDir = __DIR__ . '/web/uploads/recharge';
    if (is_dir($rechargeDir)) {
        echo "<p style='color: green;'>✅ 目录存在: $rechargeDir</p>";
        ...
        echo "<p style='color: red;'>❌ 目录不存在: $rechargeDir</p>";
    }
