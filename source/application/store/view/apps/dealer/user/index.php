                         ...
                         tpl-table-black am-text-nowrap">
                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle"><?= isset($item['rating']['name'])?$item['rating']['name']:'普通等级' ?></td>
                                    <td class="am-text-middle">
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <a class='tpl-table-black-operation-green j-selectUser' data-id="<?= $item['user_id'] ?>"  href="javascript:void(0);">
                                                <i class="iconfont icon-dizhi"></i> 新增分销用户
                                            </a>
                        ...
                        <select name="grade[rating_id]"
                            ...
                            <?php foreach ($gradeList as $item): ?>
                                <option value="<?= $item['rating_id'] ?>"
                                    <?= $grade == $item['rating_id'] ? 'selected' : '' ?>><?= $item['name'] ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
            ...
            $.showModal({
                ...
                , yes: function ($content) {
                    $content.find('form').myAjaxSubmit({
                        url: '<?= url('apps.dealer.user/grade') ?>',
