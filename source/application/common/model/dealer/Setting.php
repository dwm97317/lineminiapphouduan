    ...
    public function defaultData()
    {
        return [
            ...
            'settlement' => [
                ...
                'values' => [
                    // 提现方式
                    'pay_type' => [],   // 参数值：10微信支付 20支付宝支付 30银行卡支付 40余额支付
                    // 微信支付自动打款
                ...
                'values' => [
                    ...
                    'withdraw_apply' => [
                        ...
                        'words' => [
                            ...
                            'xieyi' => [
                                'default' => '1、提现金额将提现到当前的账户余额，金额会立即提现到余额中，如遇网络高峰，可能会有数据延迟，请耐心等待。2、如有问题，请联系客服',
                                'value' => '1、提现金额将提现到当前的账户余额，金额会立即提现到余额中，如遇网络高峰，可能会有数据延迟，请耐心等待。2、如有问题，请联系客服'
                            ],
                        ]
                    ],
                    'qrcode' => [
